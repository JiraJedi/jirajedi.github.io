...
3. You can then modify the filter to include the component(s) that correspond to the team or project you want to view by appending component = " This will ensure that each team or project only sees the issues that are relevant to them.

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc3NTE2NDI2Miw0NzIzNzE3MDksLTEwMz
