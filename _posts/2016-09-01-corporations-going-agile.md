...
![Detailed View of the Waterfall Delivery Model]({{ site.baseurl }}/assets/waterfall.png)
...
![Waterfall Approach]({{ site.baseurl }}/assets/waterfallApproach.png)
![Sprint Approach]({{ site.baseurl }}/assets/sprintApproach.png)
